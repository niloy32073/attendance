...
fun SignUp(){
    Column(modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center) {
        OutlinedTextField(modifier = Modifier.fillMaxWidth(.9f),value = "", onValueChange = {}, label = { Text(text = "Name") }, placeholder = { Text(
            text = "Enter Your Name"
        )
        })
        Spacer(modifier = Modifier.height(10.dp))
        OutlinedTextField(modifier = Modifier.fillMaxWidth(.9f),value = "", onValueChange = {}, label = { Text(text = "EIIN Number") }, placeholder = { Text(
            text = "Enter Your School EIIN No."
        )
        })
        Spacer(modifier = Modifier.height(10.dp))
        ...
        Row (modifier = Modifier.fillMaxWidth(.9f), horizontalArrangement = Arrangement.End, verticalAlignment = Alignment.CenterVertically){
            ...
            Text(text = "LogIn", modifier = Modifier.clickable { /*TODO*/ }, color = Purple40, fontWeight = FontWeight(800))
        }
    }
}